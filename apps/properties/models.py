...
class Property(TimestampedUUIDModel):
    ...
    description = models.TextField(
        verbose_name=_("Property description"), default="describe property...."
    )
    ref_code = models.CharField(
        verbose_name=_("Reference Code"), max_length=255, unique=True, blank=True
    )
    ...
    postal_code = models.CharField(
        verbose_name=_("Postal code"), max_length=150, default="72"
    )
    street_address = models.CharField(
        verbose_name=_("Street Address"), max_length=150, default="barng'etuny"
    )
